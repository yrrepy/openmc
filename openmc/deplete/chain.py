...
def _load_isomeric_branching_targets(root):
    """Delegates to :func:`openmc.deplete.gendf.chain_io._load_isomeric_branching_targets`."""
    from .gendf.chain_io import _load_isomeric_branching_targets as _impl

    return _impl(root)


def _write_embedded_yields(reaction_elem, data):
    """Delegates to :func:`openmc.deplete.gendf.chain_io._write_embedded_yields`."""
    from .gendf.chain_io import _write_embedded_yields as _impl

    return _impl(reaction_elem, data)


def _write_isomeric_branching_targets(root_elem, targets_data, lfs_data=None,
                                      q_data=None, embedded_data=None):
    """Delegates to :func:`openmc.deplete.gendf.chain_io._write_isomeric_branching_targets`."""
    from .gendf.chain_io import _write_isomeric_branching_targets as _impl

    return _impl(root_elem, targets_data, lfs_data, q_data, embedded_data)
