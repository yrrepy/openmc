...
def test_atomic_weight():
    assert openmc.data.atomic_weight('C') == 12.010735896738137
    assert openmc.data.atomic_weight('carbon') == 12.010735896738137
...
def test_isotopes():
    hydrogen_isotopes = [('H1', 0.999855), ('H2', 0.000145)]
